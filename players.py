...
while True:
    ...
    for item in playersData['data']:
        ...
        if item['height_feet'] == None:
            item['height_feet'] = ''
        PlayersData(Player).add_data(id=item['id'], first_name=item['first_name'], last_name=item['last_name'], height_inches=item['height_inches'], height_feet=item['height_feet'])
